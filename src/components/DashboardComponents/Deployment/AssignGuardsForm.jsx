...
const AssignGuardsForm = () => {
    ...
    const assignments = [
        ...
        {
            clientId: '002',
            locationId: 'K001-0011',
            deploymentDate: '1/1/2024',
            deployedTill: 'Till Date',
            totalWorkingDays: '864'
        }
    ];
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <select
                                        ...
                                        className="w-full px-4 py-3 border bg-formBgLightBlue border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none"
                                    >
                                        <option value="">Select</option>
