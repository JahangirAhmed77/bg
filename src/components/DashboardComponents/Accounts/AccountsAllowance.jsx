  ...
  return (
    <div className="w-full max-w-7xl bg-white rounded-xl shadow-md mt-8 p-8">
      ...
      <div className="flex gap-4 mt-8 mb-6">
        <button
          className={`flex-1 py-2 rounded-md text-lg font-semibold transition-all ${activeTab === 'allowance' ? 'bg-formButtonBlue text-white' : 'bg-gray-200 text-gray-400'}`}
          onClick={() => setActiveTab('allowance')}
        >
          Allowances
        </button>
        <button
          className={`flex-1 py-2 rounded-md text-lg font-semibold transition-all ${activeTab === 'deduction' ? 'bg-formButtonBlue text-white' : 'bg-gray-200 text-gray-400'}`}
      ...
      <Formik
        ...
        validationSchema={activeTab === 'allowance' ? allowanceSchema : deductionSchema}
